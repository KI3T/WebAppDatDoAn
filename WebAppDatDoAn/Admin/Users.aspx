<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="WebAppDatDoAn.Admin.Users" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID ="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                        ...
                                                                        OnClientClick="return confirm('Bạn muốn xoá người dùng này ?');">
                                                                            <i class="ti-trash"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
