<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebAppDatDoAn.User.Login" %>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div class="btn_box">
                            ...
                            <span class="pl-3 text-info">Người dùng mới? <a href="Registration.aspx" class="badge badge-info">Đăng ký..</a></span>
                        </div>
                    </div>
                </div>
            </div>
